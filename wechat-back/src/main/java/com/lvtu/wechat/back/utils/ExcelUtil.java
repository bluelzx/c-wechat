...
import com.lvtu.wechat.common.model.excel.ExcelSheet;
import com.lvtu.wechat.common.model.excel.FieldForSortting;
...
public class ExcelUtil {
        ...
        while (it.hasNext()) {
            ...
            try {
                if (t instanceof Map) {
                    ...
                    fields = sortFieldByAnno(t.getClass());
                    int cellNum = 0;
    ...
    private static List<FieldForSortting> sortFieldByAnno(Class<?> clazz) {
        ...
        for (Field field : fieldsArr) {
            ec = field.getAnnotation(ExcelCell.class);
            if (ec == null) {
