...
public class FlowController extends BaseController {
	...
	/**
	 * 返回url为https://weixin.lvmama.com/flow/index 的Base64编码
	 */
	private static String callbackUrl = "aHR0cHM6Ly93ZWl4aW4ubHZtYW1hLmNvbS9mbG93L2luZGV4";
	...
	public String index(Model model, HttpServletRequest request, HttpServletResponse response) {
        ...
        if(!WebchatUtil.isBind(wechatUser)) {
            ...
            model.addAttribute("channel", "0");//区分绑定渠道
            return "forward:/flow/toBind";
        } else {
            //判断是否已经领取过首次赠送的流量
